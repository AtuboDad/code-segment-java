...
/**
  ...
  *
  * 重要：
  *     此版本是日期2018-01-02之前运行的正式版本。
  *
  * Author: 赖传剑
  * Version: 1.0
  * Date: 2017-12-11
  */
object MergerDataIntoHiveTableSuiteV3 {

  private val logger = LoggerFactory.getLogger("MergerDataIntoHiveTableSuiteV3")
  ...
  def main(args: Array[String]): Unit = {
    ...
    if (args.length < 1) {
      ...
      println("       --class com.mundo.etl.spark.hive.MergerDataIntoHiveTableSuiteV3 \\")
    ...
    val conf = new SparkConf().setAppName("MergerDataIntoHiveTableSuiteV3")
    // 初始化SparkContext
