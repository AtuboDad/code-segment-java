...
/**
  ...
  * Date: 2017-12-11
  */
object MergerDataIntoHiveTableSuiteV2 {

  private val logger = LoggerFactory.getLogger("MergerDataIntoHiveTableV2")
  ...
  def main(args: Array[String]): Unit = {
    ...
    if (args.length < 1) {
      ...
      println("       --class com.mundo.etl.spark.hive.MergerDataIntoHiveTableV2 \\")
    ...
    val conf = new SparkConf().setAppName("MergerDataIntoHiveTableV2")
    // 初始化SparkContext
